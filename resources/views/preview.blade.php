...
<div class="container">
        <div class="center" >
        <div style="float:right;margin-top:100px;" ><img src="{{ asset('storage/images/ggh-logo-sm.jpg') }}" class="logo-img"/></div>
        ...
        <div style="margin-top:100px;font-size: 0.8rem;width:100%;text-align:center;" ><i>"This computer generated document has been already authorized electronically - No Signature Required"</i></div>
