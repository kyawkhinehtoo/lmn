                 ...
                 <input class="w-half rounded py-2 my-3 float-right" type="text" placeholder="Search city" v-model="search" v-on:keyup.enter="searchTsp">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="row in cities.data " v-bind:key="row.id">
                          ...
                          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="">
                                  ...
                                  <div class="mb-4">
                                      ...
                                      <input type="text" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" id="city" placeholder="Enter city" v-model="form.name">
