<template>
 ...
 <div class="flex justify-center mt-4 space-x-3 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div class="min-w-0 p-4 bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <vue3-chart-js v-bind="{ ...barChartSME }" />
...
export default {
  ...
  setup(props) {
    ...
    let proj_name = ref(['FTTH','SME','DIA']);
    let ftth_name = ref([]);
    let sme_name = ref([]);
    let dia_name = ref([]);
    ...
    props.ftth_total.map(function (x) {
     ...
     let sme_number = ref([]);
    props.sme_total.map(function (x) {
        sme_number.value.push(x.customers)
    });
        ...
        datasets: [
          {
            ...
            data: [props.ftth, props.sme, props.dia],
          },
        ],
      },
    };
    ...
    const barChartSME = {
      ...
      data: {
        labels: sme_name.value,
        datasets: [
          {
            label: "SME User Chart",
            backgroundColor: "#1abc9c",
            data: sme_number.value,
          },
